...
api_admin_asset = Blueprint("api_admin_asset", __name__)


@api_admin_asset.route("/history/asset/<string:key>", methods=["GET"])
def get_history(key):
    """
    ...
    chaincode.
    """
    result = GuileService.GetKeyHistory(Class="Assets", key=key)
