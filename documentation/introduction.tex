...
Il sistema da noi proposto ha come obiettivo quello di implementare un sistema di aste a \textbf{a busta chiusa}. In questo modello di aste, ciascun competitor non è a conoscenza delle offerte attuali degli altri competitor, garantendo la \textbf{segretezza} delle offerte, ciò comporta maggiore competizione tra gli offerenti. 
